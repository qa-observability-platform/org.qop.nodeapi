...
exports.up = (pgm) => {
    pgm.sql(`
    -- 1. Drop existing check constraint and add new one including cypress
    ...
    -- 2. Update get_job_prefix function to include Cypress
...
exports.down = (pgm) => {
    ...
    ALTER TABLE job_counters DROP CONSTRAINT IF EXISTS job_counters_runner_type_check;
    ALTER TABLE job_counters ADD CONSTRAINT job_counters_runner_type_check 
      CHECK (runner_type IN ('playwright', 'selenium', 'api'));
